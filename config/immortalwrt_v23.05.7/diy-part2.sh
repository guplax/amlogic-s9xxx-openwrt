...
# Source code repository: https://github.com/immortalwrt/immortalwrt / Branch: v23.05.7
#========================================================================================================================
...
echo "DISTRIB_SOURCEBRANCH='v23.05.7'" >>package/base-files/files/etc/openwrt_release
