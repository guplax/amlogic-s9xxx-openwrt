...
# Source code repository: https://github.com/immortalwrt/immortalwrt / Branch: v21.02.7
#========================================================================================================================
...
echo "DISTRIB_SOURCEBRANCH='v21.02.7'" >>package/base-files/files/etc/openwrt_release
